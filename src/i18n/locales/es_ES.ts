...
export default {
  ...
  // G
  [translation.HINT]:
    "Si aún no guardaste el código QR, puedes encontrarlo en la aplicación en la parte superior derecha de la pantalla principal",
  // I
  ...
  [translation.UPLOAD_VAULT_SHARE]:
    "Sube tu clave pública de Vultisig para comenzar",
  // V
