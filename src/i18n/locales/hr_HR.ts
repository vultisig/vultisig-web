...
export default {
  ...
  [translation.AIRDROP_LEADERBOARD]: "Poredak airdropa",
  [translation.AIRDROP_NOT_STARTED]: "Airdrop još nije započeo!",
  [translation.AIRDROP_SHARE_CALCULATION]: 
    "Vaš dio airdropa temelji se na količini imovine u Vultisigu pomnoženoj s vremenom u Vaultovima.",
  [translation.ASSENT_COUNT_MANAGE]: "Imovina koja se broji za airdrop može biti",
  // B
  [translation.BALANCES]: "Stanja",
  [translation.BECOME_VULTISIG_USER]: "Postanite korisnik Vultisiga i pridružite se izračunu airdropa.",
  ...
  [translation.CHROME_EXTENSION]: "Chrome ekstenzija",
  [translation.CHOOSE_TOKEN]: "Odaberite tokene",
  [translation.CONGRATULATIONS]: "Čestitamo!",
  [translation.CONNECT_OR_UPLOAD]: "Povežite se s VultiConnectom ili učitajte svoj QR kod vaulta za početak",
  [translation.CONNECT_YOUR_WALLET]: "Povežite svoj wallet",
  [translation.COUNTED]: "brojano",
  [translation.CURRENCY]: "Valuta",
  // D
  [translation.DAILY_UPDATE_POINTS]: "Bodovi i stanja se uvijek ažuriraju na kraju dana",
  ...
  [translation.DOWNLOAD_APP_TITLE_ONBOARDING]: "PREUZMI APLIKACIJU",
  [translation.DEFAULT_CHAINS]: "Zadani lanci",
  [translation.DELETE_VAULT_WARNING]: "Brišete Vault",
  [translation.DROP_FILE_HERE]: "Ispustite svoju datoteku ovdje ili",
  // E
  [translation.EDIT_VAULT]: "Uredite naziv svog vaulta",
  [translation.ERROR_EXISTS_IMPORT]: "Vault već postoji",
  [translation.ERROR_NOT_FOUND_IMPORT]: "Nisu pronađeni vaultovi",
  [translation.ERROR_FILE_EXTENSION]: "Nevažeća ekstenzija datoteke",
  [translation.ERROR_INVALID_FILE]: "Nevažeća datoteka",
  [translation.ETH_ARB_ADDRESS_NOT_FOUND]: "ETH/ARB adresa nije pronađena u vašem vaultu",
  // F
  ...
  [translation.JOIN_THE_AIRDROP_ONBOARDING_EXPLAIN]:
    "Pridružite se airdropu i pratite poredak na AIRDROP.VULTISIG.COM",
  // K
  // L
  ...
  [translation.LOGOUT_VAULT]: "Odjavite vault s weba",
  [translation.LOGOUT_VAULT_TITLE]: "Odjava Vaulta",
  [translation.LOGOUT_VAULT_WARNING]: "Odjavljujete Vault",
  // M
  ...
  [translation.NO_LIQUIDITY_POSITION]: "Nije pronađena pozicija likvidnosti",
  [translation.NO_LP_POSITION]: "Nije pronađena LP pozicija",
  [translation.NO_PROVIDER_POSITION]: "Nije pronađena pozicija pružatelja usluge",
  [translation.NO_SAVER_POSITION]: "Nije pronađena pozicija štednje",
  // O
  ...
  [translation.QUESTION_SECOND_ONBOARDING]: "Koja se imovina računa za airdrop?",
  [translation.QUESTION_THIRD_ONBOARDING]: "Koji je proces airdropa?",
  // R
  ...
  [translation.REGISTER_PUBLIC_KEYS_VAULTS]: "Registrirate svoje javne ključeve i adrese vaulta.",
  [translation.REGISTER_UNLIMITED_VAULTS]: "Možete registrirati koliko god vaultova želite.",
  [translation.REMOVE_VAULT]: "Uklonite svoj vault s weba",
  [translation.REMOVE_VAULT_TITLE]: "Ukloni Vault",
  [translation.REMOVE]: "Ukloni",
  [translation.RENAME_VAULT]: "Preimenujte vault",
  [translation.RENAME]: "Preimenuj",
  [translation.REPEAT_REGISTRATION]: "Možete se registrirati koliko god puta želite.",
  [translation.RUNE_PROVIDER_TITLE]: "Pružatelj Rune usluga",
  // S
  ...
  [translation.SELECT_CHAINS_TOKENS]:
    "Na ovoj stranici odaberite sve lance i tokene koje želite omogućiti da se računaju za airdrop.",
  ...
  [translation.SHARE_SETTINGS_TITLE]: "Personalizirajte stranicu podijeljenog Vaulta",
  [translation.SHARE_SETTINGS]: "Prilagodite izgled podijeljenog Vaulta",
  [translation.SHARE_VAULT_THEME]: "Tema podijeljenog Vaulta",
  [translation.SHARE_VAULT_LOGO]: "Logo podijeljenog Vaulta",
  [translation.SHARE_CURRENT_LOGO]: "Vaš trenutni logo",
  [translation.SHARE_UPLOAD_LOGO]: "Prenesite svoj logo",
  [translation.SOMETHING_WRONG]: "Nešto je pošlo po zlu",
  ...
  // T
  [translation.TGT]: "TGT",
  [translation.TITLE_ONBOARDING]: "kako sudjelovati u AIRDROPU OD <span>$5M</span> VULTISIG-a",
  [translation.TOTAL_AIRDROP_VAULT_VALUE]: "Ukupna vrijednost vaultova airdropa",
  ...
  [translation.TRANSFER_FUNDSـONBOARDING_EXPLAIN]: 
    "Uložite sredstva u Vultisig vaultove kako biste se kvalificirali za airdrop i sudjelovali u aktivnostima platforme.",

  // U
  [translation.UNSUCCESSFUL_COPY_LINK]: "Neuspješno kopiranje linka",
  [translation.UNSUCCESSFUL_COPY_TEXT]: "Neuspješno kopiranje teksta",
  [translation.UNREGISTER_VAULT_INFO]: 
    "Odjava vaulta ga uklanja s poretka. Može proći do jednog dana da se saldo ponovno prikaže.",
  [translation.UPLOAD_IT]: "učitajte ga",
  [translation.UPLOAD_QR_CODE]: "Prenesite svoj QR kod ovdje",
  [translation.UPLOAD_VAULT_SHARE]: "Prenesite svoj javni ključ Vultisig-a za početak",
  ...
  [translation.WEWE_USDT_ADDRESS_NOT_FOUND]: "WEWE/USDT adresa nije pronađena u vašem vaultu",
};
