...
export default {
  ...
  // G
  [translation.HINT]:
    "Если вы еще не сохранили QR-код, вы можете найти его в приложении в правом верхнем углу на главном экране",
  // I
  ...
  // P
  [translation.POWERED_BY]: "Под управлением",
  // Q
  // R
  ...
  [translation.SHARE_SETTINGS_TITLE]: "Настройки обмена",
  [translation.SHARE_SETTINGS]: "Измените цвета для вашей страницы обмена",
  //T
  ...
  [translation.UPLOAD_VAULT_SHARE]:
    "Загрузите свой открытый ключ Vultisig, чтобы начать",
  // V
