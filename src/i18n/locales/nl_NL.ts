...
export default {
  ...
  [translation.SHARE_SETTINGS_TITLE]: "Deelinstellingen",
  [translation.SHARE_SETTINGS]: "Wijzig de kleuren voor je deelpagina",
  //T
  ...
  [translation.UPLOAD_VAULT_SHARE]:
    "Upload uw Vultisig openbare sleutel om te beginnen",
  // V
